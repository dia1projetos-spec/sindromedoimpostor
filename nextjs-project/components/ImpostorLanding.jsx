        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="relative max-w-md mx-auto mb-12 animate-fade-in-up delay-4">
              <div className="aspect-[3/4] rounded-lg mirror-glow overflow-hidden border border-[#d4af37]/20">
                <img 
                  src="/images/capa-ebook.png" 
                  alt="O Impostor Dentro de Você - Capa" 
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-12">
              ...
              <div className="flex flex-col items-center">
                <div className="w-32 h-32 rounded-full bg-gray-800 border-2 border-[#d4af37]/30 mb-4 overflow-hidden">
                  <img 
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d3/Albert_Einstein_Head.jpg/220px-Albert_Einstein_Head.jpg" 
                    alt="Albert Einstein" 
              ...
              <div className="flex flex-col items-center">
                <div className="w-32 h-32 rounded-full bg-gray-800 border-2 border-[#d4af37]/30 mb-4 overflow-hidden">
                  <img 
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Michelle_Obama_2013_official_portrait.jpg/220px-Michelle_Obama_2013_official_portrait.jpg" 
                    alt="Michelle Obama" 
                    className="w-full h-full object-cover"
                  />
                </div>
